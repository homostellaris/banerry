				...
				<CardContent className="space-y-4">
					<div className="space-y-2">
						<p className="text-sm text-gray-600">
							...
							has invited you to help mentor:
						</p>
					...
					<div className="space-y-2">
						<p className="text-sm text-gray-600">
							...
							account with the email address this invitation was sent to.
						</p>
					...
					<div className="text-xs text-gray-500 text-center">
						If you already have an account and are signed in, the invitation
